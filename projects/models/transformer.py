...
from projects.models.SSA import SSA_Adapt
...
import numpy as np
from tools.misc.visualization import draw_feature_map
...
class CoDeformableDetrTransformerDecoder(TransformerLayerSequence):
    ...
    def forward(self,
        ...
        for lid, layer in enumerate(self.layers):
            ...
            # output=getattr(self,f"SimplifiedScaledDotProductAttention{lid}")(output,output,output)
...
class CoDeformableDetrTransformer_conv(DeformableDetrTransformer):
    ...
    def __init__(self,
        ...
        super(CoDeformableDetrTransformer_conv, self).__init__(**kwargs)
        self._init_layers()
